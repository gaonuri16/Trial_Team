...
public class ExcelManagerXlsx {
	...
	public static List<HashMap<String, String>> getListXlsxRead(String excel) throws Exception {
		...
		try {
			for( int i=0; i<1; i++ ) {  
				for( org.apache.poi.ss.usermodel.Row row : wb.getSheetAt(i) ) {
					if(check != 0) {
