package com.appspot.hihanjoong.util.file;
...
public class ExcelManager {
	...
	private HashMap<String, String> readCellData(HSSFRow row) {
		...
		hMap.put("attr01",getStringCellData(row.getCell(0)));
		hMap.put("attr02",getStringCellData(row.getCell(1)));
		hMap.put("attr03",getStringCellData(row.getCell(2)));
		return hMap;
	}	
