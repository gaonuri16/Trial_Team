                ...
                <div>
                    ...
                    <form action="<c:url value='/ins/insUpdate2'/>" name="updateForm" method="post">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" aria-label="Text input with segmented dropdown button" name="InsName" value="${insupdate.insName}">
                            <span class="input-group-text">기관 연락처</span>
                            <input type="text" class="form-control" aria-label="Text input with segmented dropdown button" name="InsPhone" value="${insupdate.insPhone}">
                            <span class="input-group-text">기관 팩스번호</span>
                            <input type="text" class="form-control" aria-label="Text input with segmented dropdown button" name="InsFaxNum" value="${insupdate.insFaxNum}">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" aria-label="Text input with segmented dropdown button" name="InsAddr" value="${insupdate.insAddr}">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" aria-label="Text input with segmented dropdown button" name="InsAddrDetail" value="${insupdate.insAddrDetail}">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" aria-label="Text input with segmented dropdown button" name="InsRgstr" value="${insupdate.insRgstr}" readonly>
                            <span class="input-group-text">기관 해제일</span>
                            <input type="text" class="form-control" aria-label="Text input with segmented dropdown button" name="InsRls" value="${insupdate.insRls}">

                        </div>
                        <input type="hidden" name="InsNum" value="${insupdate.insNum}">
                        </form>
                    </div>
